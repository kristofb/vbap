...
t_object* myobject_getmypatcher(t_dummy *x)
{
    t_object *mypatcher;
...
void dummy_int(t_dummy *x, long n)
{
    ...
    if (n==222)
    {
        t_object *thispatcher = myobject_getmypatcher(x);
        newobject_sprintf(thispatcher,
                          "@maxclass textbutton @text \"Button text\" @presentation 1 @presentation_rect 242.833344 50 100 20 @patching_rect 31 43 100 20 @bgcolor 0.095481 0.100396 0.100293 1 @parameter_enable 0 @rounded 10 @textoncolor 0.784314 0.145098 0.023529 1 ");
        newobject_sprintf(thispatcher,"@maxclass textbutton @text \"Enregistrer sous 1739\" @presentation 1 @presentation_rect 242.833344 50 100 20 @patching_rect 137 92 157 30 @bgcolor 0.095481 0.100396 0.100293 1 @parameter_enable 0 @rounded 10 @textoncolor 0.784314 0.145098 0.023529 1 ");
